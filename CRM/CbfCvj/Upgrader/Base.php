 ...
 */
class CRM_CbfCvj_Upgrader_Base {

  /**
   * @var CRM_CbfCvj_Upgrader_Base
   */
  ...
  public static function instance() {
    if (!self::$instance) {
      self::$instance = new CRM_CbfCvj_Upgrader(
        'org.citybibleforum.cbf-cvj',
        E::path()
      );
    }
   ...
   *
   * ```
   * CRM_CbfCvj_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * ```
   */
  ...
  /**
   * CRM_CbfCvj_Upgrader_Base constructor.
   *
   * @param $extensionName
   * @param $extensionDir
   */
